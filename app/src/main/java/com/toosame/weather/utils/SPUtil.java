...
public class SPUtil {
     ...
     */
    public static void setObject(Context context, String key, Object object,String SP_NAME) {
     ...
     * @return 返回保存的对象
     */
    public static <T> T getObject(Context context, String key,String SP_NAME) {
        SharedPreferences sp = context.getSharedPreferences(SP_NAME, Context.MODE_PRIVATE);
        if (sp.contains(key)) {
